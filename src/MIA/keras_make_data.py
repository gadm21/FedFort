...
with open("keras_config.yaml") as infile:
...
def keras_make_member_nonmember(finetuned_model, member_loader, nonmember_loader):
    """ 
    - finetuned_model: finetuned shadow model
    - trainloader: member
    - testloader: non-member
    ...
    for images, labels in nonmember_loader:    
        ...
        output = finetuned_model.predict(images)
